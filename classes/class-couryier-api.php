...
class COURYIER_API{
  ...
  */
  ...
  public static function getRateAPI($length,$breadth,$height,$weight,$origin,$destination){
	  ...
	  public static function getAccountAgent($account_no,$origin,$destination){
        $curl = curl_init();

curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://couryier.com/couryieragent.php',
  ...
  CURLOPT_POSTFIELDS => array('account_no' => $account_no,'origin' => $origin,'destination' => $destination),
));
...
return $response;
    ...
    public static function getRate($length,$breadth,$height,$weight,$origin,$destination){
		...
		$agent=self::getAccountAgent(SELF::getAccountNo(),$origin,$destination);
